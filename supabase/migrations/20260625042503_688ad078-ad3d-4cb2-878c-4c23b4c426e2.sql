ALTER TABLE public.sales
  ...
  ADD COLUMN IF NOT EXISTS payment_report_amount numeric,
  ADD COLUMN IF NOT EXISTS payment_report_date date,
  ADD COLUMN IF NOT EXISTS payment_report_status text;
...
ALTER TABLE public.disclosed_periods
  ...
  ADD COLUMN IF NOT EXISTS return_penalties numeric NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS stock_holding_value numeric NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS hot_cash_snapshot numeric NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS account_holding_value_snapshot numeric NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS net_worth numeric NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS cash_movements_data jsonb NOT NULL DEFAULT '[]'::jsonb;

DROP TRIGGER IF EXISTS trg_sync_return_penalty_capital ON public.returns;
DROP FUNCTION IF EXISTS public.sync_return_penalty_capital();
